...
Como algoritmo de optimización para el entrenamiento del modelo de clasificación binaria, se ha optado por utilizar AdamW(). Como se comenta en la sección \ref{sec:alg-opt} \nameref{sec:alg-opt}, Ase ha demostrado que AdamW es más eficaz en la prevención de sobreajuste en redes neuronales que otro algoritmos de optimización. Además, permite una mejor generalización en problemas con grandes volúmenes de datos como el que se trata en este proyecto.
...
\subsubsection{Capa oculta con la mitad de neuronas que parámetros de entrada}
...
\subsubsection{Capa oculta con el mismo número de neuronas que parámetros de entrada}
...
\subsubsection{Capa oculta con el doble de neuronas que parámetros de entrada}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./img/modelo/BINhs25.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./img/modelo/BINhs49.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{./img/modelo/BINhs98.pdf}
