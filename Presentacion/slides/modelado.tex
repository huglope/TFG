...
\caption{Matriz de confusión para modelos de clasificación multiclase (9 clases).}
...
\begin{itemize}
	...
	\item \textbf{MCM25}: La mitad del número de atributos o entradas que recibe el modelo
	\item \textbf{MCM49}: El mismo número que atributos o entradas que tiene el modelo.
	\item \textbf{MCM98}: El doble del número de atributos o entradas. 
...
\begin{frame}{Mejores 5 configuraciones del MCM}
